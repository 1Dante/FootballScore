...
class StandingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableViewStandingsReference.standingsProvider.fetchJSON { (standings) in
            if let standings = standings{
                self.tableViewStandingsReference.standingsArray.append(standings)
    ...
    @IBAction private func tapButtons(_ sender: UIButton){
        ...
        case 1:
            ...
            tableViewResultsReference.resultsProvider.fetchJSON { (fixture) in
                if let fixture = fixture {
                    self.tableViewResultsReference.resultsArray.append(fixture)
                    DispatchQueue.main.async {
        ...
        case 2:
            ...
            tableViewFixturesReference.fixturesProvider.fetchJSON { (fixture) in
                if let fixture = fixture {
                
                    self.tableViewFixturesReference.fixturesArray.append(fixture)
                    DispatchQueue.main.async {
